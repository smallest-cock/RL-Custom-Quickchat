...
#     'L1': 4,
#     'R1': 5,
#     'share': 8,            # <--- These button mappings are apparently incorrect/outdated. But may be worth a try if the above mappings dont work
#     'options': 9,
#     'ps': 10,
#     'up': (0, 1), 
#     'down': (0, -1), 
...
syncData(lobbyInfo=lobbyInfo, chat=chat, controller=controller)
