...
# Triggers on successive button/hat presses (buttons pressed in a specific order)... limited to a 2 button sequence
...
# ---------------------------------    Edit the code below to change quickchats, macros, spam amounts, chat modes, variations, etc.    --------------------------------------------------
                ...
                if macrosOn:
                    ...
                    # on X + up + RB, types "let me cook"
                    if combine('x', 'up', 'RB'):            # <--- you can now put any amount of buttons inside combine(...)
